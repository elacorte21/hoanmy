...
<body>
    ...
    <!-- Thumbnail -->
    <div style="background: url('assets/images/blog_2.jpg') center" class="news-cover mb-5"></div>

    <!-- Header -->
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                <h1 class="text-blue">Hanh Phuc Hospital Receives “Joint Commission International” Accreditation</h1>
                <p>News, Healthy, General Medical</p>
                <hr>
            </div>
        </div>
    </div>
    ...
    <div class="container margin-bottom-50">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                    <strong>THE FIRST MOTHER AND CHILD HOSPITAL IN VIETNAM TO ACCREDIT JOINT COMMISSION INTERNATIONAL ‘GOLD SEAL OF APPROVAL’</strong>
                    <br>
                    <br>
                    Hanh Phuc International Hospital is recognized as the first Mother and Child Hospital in Vietnam to obtain the Joint Commission International, “Gold Seal of Approval” after an arduous 2-year journey.  
                    It has achieved 99% score of the 12,00+ Measurable Elements and is proud to be on the  global JCI map.
                    <br>
                    <br>
                    <strong>Binh Duong Province – Vietnam – 27th November, 2019</strong>
                    <br>
                    <br>
                    ...
                    The Gold Seal of Approval® is a symbol of highest quality that reflects an organization’s commitment to providing safe and effective patient care and increased financial efficiencies by reducing risk.
                    <br>
                    <br>
                ...
                <div style="background: url('https://www.hoanmy.com/upload/hoanmy.com/hinhanh/tintuc/JCI.jpg')" class="news-thumb-detail">
                </div>
													   
                <p>Ms Paula Wilson, President and Chief Executive Officer of Joint Commission Resources (JCR) and its international division, Joint Commission International (JCI) delivers JCI certification to Ms Nguyen Thuc Anh, CEO of Hanh Phuc International Hospital 
                </p>
                <br>
                ...
                <div style="background: url('https://www.hoanmy.com/upload/hoanmy.com/hinhanh/tintuc/BV%20h%E1%BA%A1nh%20ph%C3%BAc.jpg')" class="news-thumb-detail">
                </div>
                <p>
